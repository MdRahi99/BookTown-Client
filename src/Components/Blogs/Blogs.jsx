...
const Blogs = () => {
    return (
        <div>
            <div className='flex justify-between items-center text-2xl font-wallPoet p-2 border-y-2 border-black uppercase text-center rounded-2xl'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 mt-6'>
                <div className='flex flex-col gap-4 font-wallPoet h-10/12 rounded-2xl p-4 shadow-lg shadow-[#545454]'>
