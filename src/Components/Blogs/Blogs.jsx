...
const Blogs = () => {
    ...
    return (
        <div>
            <div className='flex justify-between items-center text-2xl font-wallPoet p-10 border-dashed border-y-2 border-black uppercase text-center rounded-2xl my-12'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-4 mt-6'>
                <div className='flex flex-col gap-4 font-wallPoet h-10/12 rounded-2xl p-4 shadow-lg shadow-gray-300'>
