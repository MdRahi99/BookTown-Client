...
const Footer = () => {
    return (
        <footer className="footer print:hidden footer-center p-10 font-wallPoet border-dashed border-t-2 w-full lg:w-11/12 mx-auto mt-6 border-black rounded-2xl">
