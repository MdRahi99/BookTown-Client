    ...
    return (
        <div className='flex lg:flex-row flex-col justify-between lg:mx-0 mx-2 rounded-2xl'>
            <div className='flex-none w-full lg:w-1/2 border-l-2 border-black rounded-2xl p-4'>
                <img className='h-full w-full rounded-2xl' src="https://plus.unsplash.com/premium_photo-1675644727129-9e2fbc03c500?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1944&q=80" alt="" />
            </div>
            <div className='flex lg:flex-row flex-col gap-2 items-center justify-between w-full p-4 border-r-2 border-black rounded-2xl'>
