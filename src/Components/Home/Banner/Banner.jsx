    ...
    return (
        <div className='grid grid-cols-12 justify-between items-center gap-8 lg:mx-0 mx-2 rounded-2xl'>
            <Carousel className='col-span-12 lg:col-span-10 text-center rounded-xl'>
                <div className='h-96'>
                    <img className='rounded-xl h-full' src="https://images.unsplash.com/photo-1517673132405-a56a62b18caf?auto=format&fit=crop&q=80&w=1776&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
                </div>
                <div className='h-96'>
                    <img className='rounded-xl h-full' src="https://images.unsplash.com/photo-1471970471555-19d4b113e9ed?auto=format&fit=crop&q=60&w=500&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MzB8fGJvb2tzfGVufDB8fDB8fHww" />
                </div>
                <div className='h-96'>
                    <img className='rounded-xl h-full' src="https://images.unsplash.com/photo-1531280518436-9f2cc0fff88a?auto=format&fit=crop&q=80&w=2070&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
                </div>
            </Carousel>
